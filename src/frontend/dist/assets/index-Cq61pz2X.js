  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "svg",
      {
        ...
        strokeLinejoin: "round",
        "aria-hidden": "true",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20" })
      }
    )
  },
  {
...
async function getSurahFull(surahNum) {
  ...
  const ayahs = arabicAyahs.map((a, i) => {
    ...
    return {
      ...
      numberInSurah: a.numberInSurah,
      text: a.text,
      translation: ((_a2 = translationAyahs[i]) == null ? void 0 : _a2.text) ?? "",
      surahNumber: surahNum,
...
async function getDailyAyah() {
  ...
  const diff = now2.getTime() - start.getTime();
...
function Spinner({
  ...
  const spinner = /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
        width: px,
...
function DailyCard() {
  const [ayah, setAyah] = reactExports.useState(null);
  const [loading, setLoading] = reactExports.useState(true);
  const [error, setError] = reactExports.useState(false);
  const fetchDailyAyah = reactExports.useCallback(async () => {
    setLoading(true);
    setError(false);
    try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: "Ayah of the Day"
                }
              )
            ]
          }
        ),
        loading && /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, { centered: true }),
        error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "1rem" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
        ...
        ayah && !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              lang: "ar",
...
function setLastAyah(surah, ayah) {
...
function Home() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "1.5rem 1.25rem 0", textAlign: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "1.25rem" }, children: [
      ...
      (lastPage || lastAyah) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "1rem" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h3",
          {
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8 }, children: [
          lastPage && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/quran",
              style: {
          ...
          lastAyah && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/study",
              style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "1.25rem" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: QUICK_ACTIONS.map((action) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: action.path,
                style: {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 28 }, children: action.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      style: {
...
const duaData = [
  ...
  },
  {
    ...
    transliteration: "Bismillahi tawakkaltu 'ala-llahi, wa la hawla wa la quwwata illa billah",
    translation: "In the name of Allah, I put my trust in Allah, and there is no power or strength except with Allah.",
  ...
  },
  {
    ...
    transliteration: "Astaghfirullah al-'Azim alladhi la ilaha illa huwa al-Hayyu al-Qayyumu wa atubu ilayh",
    translation: "I seek forgiveness from Allah the Magnificent, besides Whom none is worthy of worship, the Ever-Living, the Sustainer, and I repent to Him.",
    source: "Tirmidhi 3577, Abu Dawud 1517"
  },
  {
    id: "d14",
    title: "Dua for rain",
    arabic: "اللَّهُمَّ اسْقِنَا غَيْثًا مُغِيثًا مَرِيئًا مَرِيعًا نَافِعًا غَيْرَ ضَارٍّ عَاجِلًا غَيْرَ آجِلٍ",
    transliteration: "Allahumma asqina ghaytan mughithan mari'an mari'an nafi'an ghayra darrin 'ajilan ghayra ajil",
    translation: "O Allah, send us refreshing, satisfying, beneficial, harmless rain, quickly and not delayed.",
  ...
  },
  {
    ...
    translation: "Our Lord, grant us good in this world and good in the Hereafter, and protect us from the torment of the Hellfire.",
    source: "Quran 2:201"
  }
];
const hadithData = [
  ...
  },
  {
    ...
    text: "Religion is sincere advice.",
    source: "Muslim 55",
  ...
  },
  {
    ...
    text: "Every son of Adam commits sins, and the best of those who commit sins are those who repent.",
    source: "Tirmidhi 2499, Ibn Majah 4251",
    narrator: "Anas ibn Malik (RA)"
  },
  {
    id: "h8",
    arabic: "اتَّقِ اللَّهَ حَيْثُمَا كُنْتَ وَأَتْبِعِ السَّيِّئَةَ الْحَسَنَةَ تَمْحُهَا",
    text: "Fear Allah wherever you are, and follow a bad deed with a good one and it will erase it.",
  ...
  },
  {
    ...
    text: "Verily, Allah does not look at your appearance or wealth, but He looks at your hearts and deeds.",
    source: "Muslim 2564",
    narrator: "Abu Hurayrah (RA)"
  },
  {
  ...
  },
  {
    ...
    text: "Islam is built upon five pillars: the testimony of faith, prayer, zakat, fasting, and Hajj.",
  ...
  },
  {
    ...
    text: "No human ever filled a vessel worse than the stomach. Sufficient for the son of Adam are a few morsels to keep his back straight.",
    source: "Tirmidhi 2380, Ibn Majah 3349",
    narrator: "Miqdam ibn Madikarib (RA)"
  },
  {
    id: "h16",
    arabic: "أَكْمَلُ الْمُؤْمِنِينَ إِيمَانًا أَحْسَنُهُمْ خُلُقًا",
    text: "The most complete of believers in faith are those who are best in character.",
    source: "Tirmidhi 1162, Abu Dawud 4682",
    narrator: "Abu Hurayrah (RA)"
  },
  {
    id: "h17",
    arabic: "إِنَّ مِنْ أَخَفِّ النَّاسِ عَذَابًا يَوْمَ الْقِيَامَةِ لَرَجُلٌ تُوضَعُ فِي أَخْمَصَيْ قَدَمَيْهِ جَمْرَتَانِ",
    text: "Smile in your brother's face is a charity; enjoining good and forbidding evil is a charity.",
  ...
  },
  {
    ...
    text: "The strong person is not the one who overcomes people by force, but the one who controls himself when angry.",
  ...
  },
  {
    ...
    text: "The best charity is that which is given out of abundance.",
    source: "Bukhari 1426, Muslim 1034",
    narrator: "Abu Hurayrah (RA)"
  }
];
const TABS = [
...
function More() {
  const [activeTab, setActiveTab] = reactExports.useState("hadith");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "1.25rem 1.25rem 0" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          style: {
        ...
        "div",
        {
          ...
          children: TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              style: {
                flexShrink: 0,
                backgroundColor: activeTab === tab.key ? "rgba(212,175,55,0.15)" : "#1a1508",
                border: activeTab === tab.key ? "1px solid rgba(212,175,55,0.5)" : "1px solid rgba(212,175,55,0.15)",
                borderRadius: 20,
                color: activeTab === tab.key ? "#d4af37" : "rgba(245,240,232,0.6)",
                padding: "6px 14px",
                fontFamily: "Poppins, sans-serif",
                fontSize: "0.8rem",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "1rem 1.25rem" }, children: [
      activeTab === "hadith" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "hadith", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            style: {
            ...
            children: "Prophetic Traditions"
          }
        ),
        hadithData.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
      ...
      activeTab === "dua" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "dua", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            style: {
            ...
            children: "Daily Supplications"
          }
        ),
        duaData.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "fiqrq-card",
            style: { marginBottom: "0.75rem" },
      ...
      activeTab === "favorites" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            style: {
            ...
            children: "Saved Ayahs"
          }
        ),
        favorites.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "3rem 1rem" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 40, marginBottom: 12 }, children: "❤️" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Save ayahs from the Study page."
            }
          )
        ] }) : favorites.map((fav) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "fiqrq-card",
            style: { marginBottom: "0.75rem" },
      ...
      activeTab === "info" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fiqrq-card", style: { marginBottom: "0.75rem" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "Islamic Companion App"
                    }
                  )
                ] })
              ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "FiqrQ (فِكْر) is your personal Islamic companion for reading and studying the Holy Qur’an, exploring authentic Hadith, and accessing daily Duʿa. Built with love for the Muslim ummah."
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Offline audio — Coming soon"
                  }
                )
              ] })
            ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Share with friends & family"
                  }
                )
              ] })
            ]
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Help us improve FiqrQ"
                  }
                )
              ] })
            ]
...
function QuranReader() {
  const [surahList, setSurahList] = reactExports.useState([]);
  const [selectedSurah, setSelectedSurah] = reactExports.useState(1);
  const [ayahs, setAyahs] = reactExports.useState([]);
  const [currentPage, setCurrentPage] = reactExports.useState(0);
  const [loadingSurahs, setLoadingSurahs] = reactExports.useState(true);
  const [loadingAyahs, setLoadingAyahs] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    ...
    }).catch(() => setError("Failed to load surah list")).finally(() => setLoadingSurahs(false));
  }, []);
  reactExports.useEffect(() => {
    if (loadingSurahs) return;
    setLoadingAyahs(true);
    setError("");
    getSurahArabic(selectedSurah).then((data) => {
      setAyahs(data);
      setCurrentPage(0);
    }).catch(() => setError("Failed to load surah. Check your connection.")).finally(() => setLoadingAyahs(false));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-container", children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
                  ...
                  currentSurahInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "p",
                    {
                      style: {
                        fontFamily: "Poppins, sans-serif",
                ...
                currentSurahInfo && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    lang: "ar",
                    dir: "rtl",
                    ...
                    children: currentSurahInfo.name
                  }
                )
              ]
            }
          ),
          !loadingSurahs && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              className: "fiqrq-select",
              value: selectedSurah,
              onChange: (e) => setSelectedSurah(Number(e.target.value)),
              children: surahList.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: s.number, children: [
                s.number,
                ". ",
                s.englishName,
                " — ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          (loadingSurahs || loadingAyahs) && /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, { centered: true }),
          error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "2rem" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "rgba(245,240,232,0.5)", marginBottom: 12 }, children: error }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          !loadingAyahs && !error && pageAyahs.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            showBismillah && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                lang: "ar",
                dir: "rtl",
            ...
            pageAyahs.map((ayah) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: "1rem" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                lang: "ar",
                dir: "rtl",
    ...
    !loadingAyahs && totalPages > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          position: "sticky",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              style: {
                backgroundColor: currentPage === 0 ? "rgba(212,175,55,0.05)" : "rgba(212,175,55,0.1)",
                border: "1px solid rgba(212,175,55,0.3)",
                borderRadius: 10,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              style: {
                backgroundColor: currentPage === totalPages - 1 ? "rgba(212,175,55,0.05)" : "rgba(212,175,55,0.1)",
                border: "1px solid rgba(212,175,55,0.3)",
                borderRadius: 10,
                color: currentPage === totalPages - 1 ? "rgba(212,175,55,0.3)" : "#d4af37",
                padding: "8px 20px",
                fontFamily: "Poppins, sans-serif",
                fontSize: "0.85rem",
...
function AyahCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        backgroundColor: "#1a1508",
        border: isPlaying ? "1px solid rgba(212,175,55,0.5)" : "1px solid rgba(212,175,55,0.15)",
        borderLeft: isPlaying ? "3px solid #d4af37" : "1px solid rgba(212,175,55,0.15)",
        borderRadius: 16,
        padding: "1.25rem",
        marginBottom: "0.75rem",
        boxShadow: isPlaying ? "0 0 20px rgba(212,175,55,0.12)" : "0 2px 12px rgba(0,0,0,0.3)",
      ...
      children: [
        ...
        ayah.translation && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            style: {
              fontFamily: "Poppins, sans-serif",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              style: {
                backgroundColor: isPlaying ? "rgba(212,175,55,0.2)" : "rgba(212,175,55,0.08)",
                borderColor: "rgba(212,175,55,0.5)",
                color: "#d4af37",
                minWidth: 72
              },
              children: [
                isLoadingAudio ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: onCopy, className: "action-btn", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                width: "11",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: onShare, className: "action-btn", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                width: "11",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: onFavorite,
              className: isFavorite2 ? "action-btn active" : "action-btn",
              style: isFavorite2 ? {
                borderColor: "#d4af37",
                color: "#d4af37",
...
let listeners = [];
function notifyListeners(url, loading) {
...
function useAudio() {
  const [playingUrl, setPlayingUrl] = reactExports.useState(globalPlayingUrl);
  const [isLoading, setIsLoading] = reactExports.useState(false);
  reactExports.useEffect(() => {
    const handler = (url, loading) => {
      setPlayingUrl(url);
  ...
  const play = reactExports.useCallback((url) => {
    audioPlay(url);
  }, []);
  const pause = reactExports.useCallback(() => {
    audioPause();
  }, []);
  const toggle = reactExports.useCallback((url) => {
...
function Study() {
  const [surahList, setSurahList] = reactExports.useState([]);
  const [selectedSurah, setSelectedSurah] = reactExports.useState(1);
  const [surahInfo, setSurahInfo] = reactExports.useState(null);
  const [ayahs, setAyahs] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(true);
  const [error, setError] = reactExports.useState("");
  ...
  const currentAyahIndexRef = reactExports.useRef(-1);
  ...
  const refreshFavorites = reactExports.useCallback(() => {
    const favs = getFavorites();
  ...
  reactExports.useEffect(() => {
    ...
    setLoading(true);
    setError("");
    getSurahFull(selectedSurah).then(({ surah, ayahs: fetchedAyahs }) => {
      setSurahInfo(surah);
      setAyahs(fetchedAyahs);
    }).catch(() => setError("Failed to load surah. Check your connection.")).finally(() => setLoading(false));
  }, [selectedSurah, surahList]);
  reactExports.useEffect(() => {
    const handler = (e) => {
      const endedUrl = e.detail.url;
  ...
  const handleCopy = reactExports.useCallback((ayah) => {
...
— ${ayah.surahEnglishName} ${ayah.numberInSurah}`;
  ...
  const handleShare = reactExports.useCallback((ayah) => {
    const text = `${ayah.text}
...
— ${ayah.surahEnglishName}, ${ayah.numberInSurah}`;
  ...
  const handleFavorite = reactExports.useCallback(
    (ayah) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-container", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              ...
              children: "Study Qur’an"
            }
          ),
          surahList.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              className: "fiqrq-select",
              value: selectedSurah,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, style: { padding: "1rem 1.25rem" }, children: [
      loading && /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, { centered: true }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "2rem" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "rgba(245,240,232,0.5)", marginBottom: 12 }, children: error }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      !loading && !error && surahInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: surahInfo.englishName
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
        ...
        copied !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              position: "fixed",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/quran", element: /* @__PURE__ */ jsxRuntimeExports.jsx(QuranReader, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/study", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Study, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/more", element: /* @__PURE__ */ jsxRuntimeExports.jsx(More, {}) })
      ] })
    }
  ) });
}
...
function eddsa(Point, cHash, eddsaOpts = {}) {
  ...
  const { BASE: BASE2, Fp: Fp2, Fn } = Point;
